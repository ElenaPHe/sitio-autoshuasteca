        ...
        <!-- <footer class="bg-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-sm text-gray-600">© 2021 Autos de la Huasteca. Todos los derechos reservados.</p>
                    </div>
                    <div>
                        <a href="https://www.facebook.com/your-facebook-page" target="_blank" rel="noopener noreferrer"
                            ...
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 4H8a2 2 0 00-2 2v12a2 2 0 002 2h4v-6H9V9h3V7a5 5 0 015 5h3v3h-3a2 2 0 01-2-2v-3a2 2 0 012-2h3V6a2 2 0 00-2-2z" />
                            </svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="py-7 border-t border-gray-200">
                    <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row text-center">
                        ...
                        <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            ...
                            <a href="https://twitter.com/2302VWHUASTECA?lang=es" target="_blank"  class="w-9 h-9 rounded-full flex justify-center items-center">
